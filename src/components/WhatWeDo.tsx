          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold text-left mb-4 leading-tight max-w-xl">
                Our Lead Generation Agency Does the Outreach. You Close the Deals.
              </h2>
              <p className="text-lg leading-relaxed mb-1">
                As a dedicated B2B lead generation agency, we handle every step of the prospecting process. We define your ideal clients together and reach out to them using our advanced AI system.
              </p>
              <p className="text-lg leading-relaxed">
                Whenever a prospect shows genuine interest, we schedule a warm meeting on your calendar. You focus on delivering your product and closing deals, not prospecting.
              </p>
            </div>
